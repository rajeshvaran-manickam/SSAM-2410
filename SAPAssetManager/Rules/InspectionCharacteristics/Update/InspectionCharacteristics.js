                    ...
                    if (sectionBindings && sectionBindings.length > 0) {
                        for (let i = 0; i < sectionBindings.length; i++) {
                            ...
                            if (odataType === '#sap_mobile.InspectionCharacteristic') {
                                let entity = `InspectionCharacteristics(InspectionLot='${binding.InspectionLot}',InspectionNode='${binding.InspectionNode}',InspectionChar='${code.Item}',SampleNum='${binding.SampleNum}')`;
