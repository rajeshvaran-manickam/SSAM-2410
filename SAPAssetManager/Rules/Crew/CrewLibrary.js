...
export default class {
    ...
    */
    ...
    static getTotalHoursWithDateForCurrentCrew(context, date) {
        ...
        const queryOptions = `$expand=Employee&$orderby=Employee/LastName&$filter=(RemovalFlag ne 'X' or sap.hasPendingChanges()) and CrewList/SAPUserName eq '${libCom.getSapUserName(context)}' and CrewList/OriginTimeStamp eq ${odataDate} and CrewItemType eq 'EMPLOYEE'`;
