...
export default function CreateEntitySuccessMessage(context) {
    ...
    switch (objectCreatedName) {
        ...
        case 'ServiceQuotation':
            return context.localizeText('object_successfully_created', [context.localizeText('service_quotation')]);
        case 'ServiceQuotationItem':
            return context.localizeText('object_successfully_created', [context.localizeText('service_quotation_item')]);
        case 'Notification':
