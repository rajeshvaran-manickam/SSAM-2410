...
export function DeltaSyncInit(pageProxy) {
    ...
    return Promise.all([appParamRead, userSysRead, userGenRead, itemCategoryRead, inspectionValuationsRead])
        .then(() => CacheMobileStatusTexts(pageProxy))
        .then(() => CacheMobileStatusSequences(pageProxy))
